...
| 9 | [Data Registry](09-data-registry.md) | Annotation-gated cross-namespace data asset discovery server, RBAC, TLS, observability |
...
- **"How do I enable the cross-namespace Data Registry?"** → [Guide 9](09-data-registry.md)
